...
const path = require('path'); // NOVO CÓDIGO: Necessário para manipular caminhos de arquivo no Express
...
// NOVO CÓDIGO PARA SERVIR ARQUIVOS ESTÁTICOS
// Configura o Express para servir o Front-end (HTML, CSS, JS)
// O '..' sobe da pasta 'api' para a raiz e acessa 'frontend'
app.use(express.static(path.join(__dirname, '..', 'frontend')));

// Rota Raiz Correção (GET /)
// Garante que a página de login seja exibida quando o usuário acessa a URL raiz do Render.
app.get('/', (req, res) => {
